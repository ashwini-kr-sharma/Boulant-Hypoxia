...
## Hypoxia vs Normoxia (6hr)

```{r}

datatable(dge$T_6hr, rownames = FALSE, filter="top", class="compact",
           caption = "Differential gene expression analysis - Hypoxia vs Normoxia (6hr)",
