...
## Hypoxia vs Normoxia (Day 1)

```{r}

datatable(dge$T_D1, rownames = FALSE, filter="top", class="compact",
          caption = "Differential gene expression analysis - Hypoxia vs Normoxia (Day 1)",
