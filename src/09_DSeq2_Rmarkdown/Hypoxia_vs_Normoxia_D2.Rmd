...
## Hypoxia vs Normoxia (Day 2)

```{r}

datatable(dge$T_D2, rownames = FALSE, filter="top", class="compact",
          caption = "Differential gene expression analysis - Hypoxia vs Normoxia (Day 2)",
